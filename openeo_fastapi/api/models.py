...
class Capabilities(BaseModel):
    ...
    id: str = Field(
        ...
        json_schema_extra={"example": "cool-eo-cloud"},
    )
    title: str = Field(
        ...,
...
class BatchJob(BaseModel):
    ...
    job_id: Optional[uuid.UUID] = Field(default=None, alias="id")
    ...
    created: Optional[RFC3339Datetime] = None
...
class JobsGetEstimateGetResponse(BaseModel):
    ...
    expires: Optional[RFC3339Datetime] = Field(
        ...
        json_schema_extra={"example": "2020-11-01T00:00:00Z"},
    )
